...
PDF_SECTIONS = [
    ...
    {"key": "planetary_dignities", "title": "Planetary Dignities & Conditions", "style": "major", "bullets": False},
...
SECTION_PATTERNS = {
    ...
    "planetary_dignities": [r"planetary dignities.*conditions", r"planetary dignities", r"dignities.*conditions"],
...
def format_section_content(content: str, is_bullet_section: bool, styles_dict: dict, story: list):
    ...
    def is_subsection_heading(line: str) -> bool:
        ...
        patterns = [
            ...
            r'^planetary dignities.*conditions:?\s*$',
            r'^exaltation:?\s*$',
            r'^fall:?\s*$',
            r'^detriment:?\s*$',
            r'^domicile:?\s*$',
            ...
            r'^family dynamics.*analysis:?\s*$',
            r'^childhood patterns:?\s*$',
            r'^healing modalities:?\s*$',
            # Work/Money subsections
            r'^specific career paths:?\s*$',
            r'^detailed money patterns:?\s*$',
            r'^mars.*analysis:?\s*$',
            r'^the life theme:?\s*$',
