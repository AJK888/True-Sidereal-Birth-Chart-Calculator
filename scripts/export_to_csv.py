...
def export_to_csv(output_file=None):
    ...
    fieldnames = [
        ...
        'moon_sign_sidereal',
        'moon_sign_tropical',
        'rising_sign_sidereal',
        'rising_sign_tropical',
        'life_path_number',
        'day_number',
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        for record in records:
            row = {
                ...
                'rising_sign_sidereal': record.rising_sign_sidereal or '',
                'rising_sign_tropical': record.rising_sign_tropical or '',
                ...
                'chinese_zodiac_element': record.chinese_zodiac_element or '',
